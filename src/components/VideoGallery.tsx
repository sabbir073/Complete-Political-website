...
const VideoGallery: React.FC = () => {
  ...
  useEffect(() => {
    const fetchVideos = async () => {
      try {
        // Fetch only featured and published videos for homepage
        const res = await fetch('/api/video-gallery?featured=true&limit=3');
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className={`text-center md:text-left mb-12 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between">
              ...
              <Link href="/gallery/videos" className="hidden md:inline-block">
                  ...
                  <div className={`rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-[1.02] overflow-hidden ${
                    ...
                    <div className={`relative h-48 overflow-hidden ${
                      ...
                      <Image
                        ...
                        unoptimized={thumbnailUrl?.includes('cloudfront') || thumbnailUrl?.includes('youtube')}
                      />
                    ...
                    <div className="p-6">
                      {/* Title */}
                      <h3 className={`text-xl font-bold mb-1 transition-colors duration-300 line-clamp-2 ${
                        isDark
