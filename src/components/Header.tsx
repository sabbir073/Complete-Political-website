...
export default function Header({ initialSettings }: HeaderProps = {}) {
  ...
  return (
    <>
      <header
        className={`public-header border-b backdrop-blur-lg transition-all duration-500 ease-in-out z-[9999] ${settings.header_position === 'fixed'
          ...
          <div className="flex justify-between items-center px-4 lg:px-6 py-3 lg:py-4">
            ...
            <div className="hidden lg:flex items-center space-x-3">
              ...
              {settings.header_show_language_toggle && (
                <button
                  ...
                  className={`px-3.5 py-2 text-sm font-semibold rounded-lg border transition-all duration-300 ${isDark
              ...
              {/* <a
                ...
                className="bg-gradient-to-r from-green-600 to-green-700 text-white px-5 py-2.5 rounded-lg font-semibold text-sm transition-all duration-300 hover:from-green-700 hover:to-green-800 hover:scale-105 shadow-lg hover:shadow-xl flex items-center space-x-2"
              >
            ...
            <div className="flex lg:hidden items-center space-x-2">
              ...
              {settings.header_show_language_toggle && (
                <button
                  onClick={() => changeLanguage(language === 'bn' ? 'en' : 'bn')}
                  className={`px-2.5 py-1.5 text-xs font-bold rounded-md border transition-all duration-300 ${isDark
