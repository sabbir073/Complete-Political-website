        ...
        <div className="container mx-auto">
          <div className="flex justify-between items-center px-4 lg:px-6 py-3 lg:py-4">
            ...
            <div className="hidden lg:flex items-center space-x-3">
              ...
              <Link
                href="/emergency/sos"
                className="bg-gradient-to-r from-orange-500 to-orange-600 text-white px-5 py-2.5 rounded-lg font-semibold text-sm transition-all duration-300 hover:from-orange-600 hover:to-orange-700 hover:scale-105 shadow-lg hover:shadow-xl flex items-center space-x-2"
              >
