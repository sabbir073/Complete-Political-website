...
// Enterprise Request Manager with retry and deduplication
...
// Enterprise profile fetcher with caching and retry
...
export const useAuthStore = create<AuthState>()(
  subscribeWithSelector((set, get) => ({
    ...
    getSessionInfo: () => ({
      ...
      lastActivity: sessionManager['lastActivity'] ? new Date(sessionManager['lastActivity']).toISOString() : null,
    }),
