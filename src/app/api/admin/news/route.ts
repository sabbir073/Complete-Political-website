...
// GET /api/admin/news - List all news with filtering
...
export async function POST(request: NextRequest) {
    try {
        ...
        if (!body.title_en || !body.title_bn || !body.content_en || !body.content_bn || !body.slug) {
            return NextResponse.json(
        ...
        const readTime = body.read_time || calculateReadTime(body.content_en);
