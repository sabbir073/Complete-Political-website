...
// GET /api/settings/footer - Public endpoint for footer settings (no auth required)
export async function GET(request: NextRequest) {
  try {
    ...
    if (error) {
      console.error('Public footer settings fetch error:', error);
    ...
    console.error('Public footer settings API error:', error);
    return NextResponse.json(
