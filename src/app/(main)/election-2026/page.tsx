    ...
    <div className={`min-h-screen ${isDark ? 'bg-gray-900' : 'bg-gray-50'}`}>
      ...
      <div className="relative py-16 md:py-24 bg-gradient-to-br from-green-700 via-green-600 to-red-600 overflow-hidden">
        ...
        <div className="relative container mx-auto px-4 text-center text-white">
          ...
          <h1 className="text-3xl md:text-5xl lg:text-6xl font-bold mb-4">{t.title}</h1>
          <p className="text-lg md:text-xl lg:text-2xl opacity-95 max-w-3xl mx-auto mb-2 font-medium">{t.heroMessage}</p>
          <p className="text-base md:text-lg opacity-80 max-w-2xl mx-auto">{t.joinMovement}</p>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className={`rounded-2xl p-6 md:p-8 ${isDark ? 'bg-gray-800' : 'bg-white'} shadow-xl`}>
              <div className="text-center mb-6">
                {/* Paddy Icon */}
                <div className="inline-flex items-center justify-center w-20 h-20 rounded-full bg-gradient-to-r from-green-500 to-green-600 text-white mb-4">
                  <img
              ...
              {pledgeSuccess ? (
                ...
                <div className="text-center">
                  ...
                  {/* Beautiful Support Card - Compact Version */}
                  ...
                  <div className="mt-6">
                    ...
                    <div className="flex flex-wrap justify-center gap-3">
                      ...
                      <button
                        ...
                        className="p-3 rounded-full bg-blue-600 hover:bg-blue-700 text-white transition-colors cursor-pointer"
                        title="Facebook"
                      >
                      ...
                      <button
                        ...
                        className="p-3 rounded-full bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white transition-colors cursor-pointer"
                        title="Messenger"
                      >
                        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                      ...
                      <button
                        ...
                        className="p-3 rounded-full bg-black hover:bg-gray-800 text-white transition-colors cursor-pointer"
                        title="X (Twitter)"
                      >
                        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                      ...
                      <button
                        ...
                        className="p-3 rounded-full bg-sky-500 hover:bg-sky-600 text-white transition-colors cursor-pointer"
                        title="Telegram"
                      >
                        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                      ...
                      <button
                        ...
                        className="p-3 rounded-full bg-blue-700 hover:bg-blue-800 text-white transition-colors cursor-pointer"
                        title="LinkedIn"
                      >
                        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                      ...
                      <button
                        onClick={copyLink}
                        className="p-3 rounded-full bg-gray-600 hover:bg-gray-700 text-white transition-colors cursor-pointer"
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <button
                    type="submit"
                    disabled={submitting}
                    className="w-full py-4 bg-gradient-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 text-white rounded-xl font-bold text-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer flex items-center justify-center gap-3 shadow-lg hover:shadow-xl"
                  >
                    {submitting ? (
                      <>
                        <div className="animate-spin rounded-full h-5 w-5 border-b-2 border-white"></div>
            ...
            <div className={`rounded-2xl p-6 md:p-8 ${isDark ? 'bg-gray-800' : 'bg-white'} shadow-xl h-fit`}>
              ...
              <div className={`mt-4 p-4 rounded-xl border-2 border-dashed ${
                ...
                <div className="flex items-center gap-3">
                  ...
                  />
                  <div>
                    <p className={`font-bold ${isDark ? 'text-green-400' : 'text-green-700'}`}>
