...
export default function EventDetailClient({ slug, initialEvent }: Props) {
    ...
    useEffect(() => {
        ...
        if (slug && !initialEvent) {
            fetchEvent();
        }
    }, [slug, initialEvent]);

    const shareUrl = typeof window !== 'undefined' ? window.location.href : `https://smjahangir.com/events/${slug}`;
